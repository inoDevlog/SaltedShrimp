    ...
    <div class="row">
      <div class="col-md-8 mx-auto">
        ...
        <div class="bg-light p-3 form-control-sm">
          <h4 class="display-4 text-center">POST VIDEO</h4>
          <hr>
<!-- 입력폼 -->
          <form class="" method="post" action="">
            <div class="form-group my-2">
              ...
              <div class="dropdown">
                ...
                <select class="form-control" value="Select">
                  <option class="dropdown-item select" value="DUKJIL" selected="TRUE">DUKJIL</option>
            ...
            <!-- 글 제목 -->
            <div class="form-group my-2"> <label>TITLE</label>
              <input class="form-control" placeholder="제목">
            </div>
            <!-- 파일선택 양식-->
            <div class="form-group my-2"> <label>VIDEO FILE</label>
            ...
            <button type="submit" class="btn mt-4 btn-block p-2 btn-secondary"><b>등록</b></button>
          </form>
      </div>
      </div>
    </div>
